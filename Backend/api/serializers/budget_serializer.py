...
class CreateBudgetSerializer(serializers.Serializer):
    ...
    period = serializers.ChoiceField(choices=['daily', 'weekly', 'monthly', 'quarterly', 'yearly'])
...
class UpdateBudgetSerializer(serializers.Serializer):
    ...
    period = serializers.ChoiceField(choices=['daily', 'weekly', 'monthly', 'quarterly', 'yearly'], required=False)
