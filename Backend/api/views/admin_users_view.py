...
API endpoints cho Admin Dashboard quản lý người dùng.
"""
...
class AdminUsersViewSet(viewsets.ViewSet):
    ...
    @extend_schema(
        parameters=[
            ...
            OpenApiParameter(name='search', description='Tìm kiếm theo tên hoặc email', required=False, type=str),
            OpenApiParameter(name='is_active', description='Filter theo trạng thái active', required=False, type=bool),
    ...
    def toggle_status(self, request, pk=None):
        ...
        return Response({
            ...
            'message': f'Đã {action_text} người dùng {user.email}'
        })
